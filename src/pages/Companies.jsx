      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center justify-center w-9 h-9 rounded-lg border border-gray-200 text-gray-500 hover:bg-gray-50 hover:text-[#1B6B6B] transition-colors"
            ...
            <form onSubmit={handleSubmitCompany} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#1B6B6B]/20 focus:border-[#1B6B6B]"
                  required
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={handleFormChange}
                  maxLength={2}
                  className="w-full rounded-xl border border-gray-200 px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-[#1B6B6B]/20 uppercase"
                />
              </div>
              <div>
