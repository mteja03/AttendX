  ...
  return (
    <div className="min-h-screen flex bg-[#FAFBFB]" style={{ fontFamily: "'DM Sans', system-ui, sans-serif" }}>
      ...
      <main className="flex-1 flex flex-col bg-white relative">
        {/* Subtle ambient backdrop on right side */}
        <div
          className="absolute inset-0 pointer-events-none opacity-60"
          style={{
            background:
              'radial-gradient(60% 40% at 50% 0%, rgba(27,107,107,0.04) 0%, transparent 70%)',
          }}
          aria-hidden
        />
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-10 lg:py-12 relative z-10">
          <div className="w-full max-w-[380px] animate-[loginRise_0.5s_ease-out]">
