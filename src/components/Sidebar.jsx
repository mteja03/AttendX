    ...
    <aside className="w-64 min-h-screen bg-white border-r border-slate-200 flex flex-col">
      <div className="p-6 border-b border-slate-200">
        <div className="flex items-center gap-3">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-primary-600 text-white font-semibold tracking-tight">
            <span className="text-sm">AX</span>
          </div>
          <div>
            <h1 className="text-xl font-semibold text-primary-700">AttendX</h1>
            <p className="text-slate-500 text-sm mt-0.5">HR Management Platform</p>
          </div>
        </div>
      </div>
